...
class TestGoogleUtils:
    ...
    def test_get_calendar_events_no_items_to_ignore(self):
        ...
        # ASSERT
        expected_events = {
            "2024-02-15T10:00:00-0": {
                "summary": "Event1",
                "start": {"dateTime": "2024-02-15T10:00:00"},
            },
            "2024-02-15T12:00:00-0": {
                "summary": "Event2",
                "start": {"dateTime": "2024-02-15T12:00:00"},
            },
        }
        assert actual_events == expected_events
    ...
    def test_parse_calendar_events_12h_timeformat(self):
        ...
        events = {
            "2024-02-15T10:00:00-0": {
                "summary": "Event1",
                "start": {"dateTime": "2024-02-15T10:00:00"},
                "end": {"dateTime": "2024-02-15T12:00:00"},
            }
        }
        timeformat = "12h"
    ...
    def test_parse_calendar_events_24h_timeformat(self):
        # ARrANGE
        events = {
            "2024-02-15T14:30:00-0": {
                "summary": "Event2",
                "start": {"dateTime": "2024-02-15T14:30:00"},
                "end": {"dateTime": "2024-02-15T16:30:00"},
            }
        }
        timeformat = "24h"
    ...
    def test_parse_calendar_events_multiple_events(self):
        ...
        events = {
            ...
            "2024-02-16T15:30:00-0": {
                "summary": "Event2",
                "start": {"dateTime": "2024-02-16T15:30:00"},
                "end": {"dateTime": "2024-02-16T17:30:00"},
            },
        }
        timeformat = "12h"
