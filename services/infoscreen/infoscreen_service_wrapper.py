...
class InfoScreenServiceWrapper:
    def __init__(self, config):
        self.infoscreen_service_url = f"http://{os.environ['infoscreen_service_name']}:{os.environ['infoscreen_service_port']}"
    ...
    def refresh_all_panels(self, config):
        self.update_date_info_panel(
            config["infoscreen"]["panels"]["date_info"], clear_display_sleep=False
        )
        self.update_calendar_panel(
            config["infoscreen"]["panels"]["calendar"], clear_display_sleep=False
        )
        self.update_shopping_list_panel(
            config["infoscreen"]["panels"]["shopping_list"], clear_display_sleep=False
        )
        self.update_mental_load_panel(
            config["infoscreen"]["panels"]["mental_load"], clear_display_sleep=False
        )
    ...
    def update_weather_panel(self, panel_config, clear_display_sleep=True):
        ...
        forecast_data = requests.get(
            self.weather_service_url + "/get_weather_forecast_data"
        )
        json_params = {
        ...
        return requests.post(
            self.infoscreen_service_url + "/update_weather_panel", json=json_params
        )

    def update_shopping_list_panel(self, panel_config, clear_display_sleep=True):
        shopping_list_content = self.google_service_wrapper.get_document_content(
        ...
        return requests.post(
            self.infoscreen_service_url + "/update_shopping_list_panel",
            json=json_params,
        )

    def update_mental_load_panel(self, panel_config, clear_display_sleep=True):
        mental_load_content = self.google_service_wrapper.get_document_content(
            document_id=self.mental_load_doc_id
        )
        json_params = {
        ...
        return requests.post(
            self.infoscreen_service_url + "/update_mental_load_panel", json=json_params
        )
    ...
    def update_calendar_panel(self, panel_config, clear_display_sleep=True):
        ...
        return requests.post(
            self.infoscreen_service_url + "/update_calendar_panel", json=json_params
        )
    ...
    def update_date_info_panel(self, panel_config, clear_display_sleep=True):
        ...
        return requests.post(
            self.infoscreen_service_url + "/update_date_info_panel", json=json_params
        )
