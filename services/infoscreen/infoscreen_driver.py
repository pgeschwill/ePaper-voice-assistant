...
class InfoscreenDriver:
    ...
    def run_screensaver(self):
        ...
        self.epd.init()
        colors = (self.epd.WHITE, self.epd.BLACK, self.epd.GREEN, self.epd.BLUE, self.epd.RED, self.epd.YELLOW, self.epd.ORANGE)
    ...
    def get_current_image(self):
        return self.infoscreen_helper.get_current_image(self.epd.width, self.epd.height, self.epd.WHITE)
