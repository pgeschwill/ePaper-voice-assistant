...
class GoogleServiceWrapper:
    ...
    def insert_in_document(self, document_id, insert_payload):
        params = {"document_id": document_id, "insert_payload": insert_payload}
    ...
    def get_document_content(self, document_id):
        params = {"document_id": document_id}
        return requests.get(
            self.google_service_url + "/get_document_content", params=params
        )

    def get_calendar_items(
        self, calendar_names=[], items_to_ignore=[], timeformat="24h", timezone=None
    ):
        params = {
        ...
        return requests.get(
            self.google_service_url + "/get_calendar_items", params=params
        )
